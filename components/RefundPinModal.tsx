...
interface RefundPinModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (pin: string) => Promise<void>;
}

const RefundPinModal: React.FC<RefundPinModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-80 z-[60] flex items-center justify-center backdrop-blur-md">
            <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-sm">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">Konfirmasi Refund</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        >
                            {isLoading ? 'Memproses...' : 'Konfirmasi Refund'}
                         </button>
                    </div>
                </form>
            </div>
